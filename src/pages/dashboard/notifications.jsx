...
import { authorsTableData, activeHistoryData } from "@/data";
      ...
      <Card>
        ...
        <CardBody className="overflow-x-scroll px-0 pt-0 pb-2">
          <table className="w-full min-w-[640px] table-auto">
            <thead>
              <tr>
                {["ID", "Air-conditioner", "light", "fan", "time"].map((el) => (
                  <th
                    key={el}
            ...
            <tbody>
              {activeHistoryData.map(({ id, AC, light, fan, time }, key) => {
                ...
                return (
                  <tr key={id} className="text-center">
                    ...
                    <td className="text-xs font-bold text-black">{light}</td>
                    <td className={className}>
                      <Typography className="text-xs font-bold text-black">
                        {fan}
                      </Typography>
